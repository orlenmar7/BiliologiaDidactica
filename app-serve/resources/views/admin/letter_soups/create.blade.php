    ...
    <div class="col-md-8">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Gestionar Sopa de letras <b><small>{{$history->title}}</small></b></h3>
            ...
            <div class="panel-content">
                <create-letter-soups props_history="{{ json_encode($history) }}"></create-letter-soups>
            </div>
        </div>
    </div>
</div>
